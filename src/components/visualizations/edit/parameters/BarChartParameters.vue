      ...
      <v-row justify="center">
        <v-col lg="6">
          <v-slider
            ...
            :label="$t('visualizations.add.parameters.barchart.prune_least_cited', { percent: visualization.parameters.pruneLeastCitedPercentage })"
            :min="0"
            :max="100"
            thumb-label="always"
          ></v-slider>
...
@Component
export default class BarChartParameters extends Vue {
  @Prop() readonly visualization!: BarChartVisualization
